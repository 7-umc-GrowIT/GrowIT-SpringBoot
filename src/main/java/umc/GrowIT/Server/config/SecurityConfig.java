    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/auth/login/email", "/auth/login/kakao", "/auth/email", "/auth/users/password", "/auth/users", "/terms", "/auth/verification", "/auth/reissue").permitAll() //인증 없이 접근 가능
