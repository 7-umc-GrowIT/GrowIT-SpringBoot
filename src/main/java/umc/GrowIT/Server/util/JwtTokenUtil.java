...
//    public static final long REFRESH_TOKEN_EXPIRATION_MS = 60L * 24 * 60 * 60 * 1000; // Refresh token 만료 시간 60일
    public static final long ACCESS_TOKEN_EXPIRATION_MS = 1L * 60 * 1000; // Access token 만료 시간 3분 (임시)
    public static final long REFRESH_TOKEN_EXPIRATION_MS = 2L * 60 * 1000; // Refresh token 만료 시간 30분 (임시)
