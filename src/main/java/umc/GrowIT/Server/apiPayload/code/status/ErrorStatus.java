...
public enum ErrorStatus implements BaseErrorCode {
    ...
    CHALLENGE_VERIFY_NOT_FOUND(HttpStatus.NOT_FOUND, "CHALLENGE4002", "챌린지 인증 내역이 존재하지 않습니다."),
    ...
    CHALLENGE_VERIFY_NOT_EXISTS(HttpStatus.BAD_REQUEST, "CHALLENGE4005", "미완료 상태의 챌린지는 인증 내역을 볼 수 없습니다."),
