...
public enum ErrorStatus implements BaseErrorCode {
    ...
    //그로관련
    GroNICKNAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "GRO4001", "이미 사용 중인 닉네임입니다."),
    GroNICKNAME_LENGTH_INVALID(HttpStatus.BAD_REQUEST, "Gro4002", "닉네임은 2글자에서 10글자 사이여야 합니다."),
