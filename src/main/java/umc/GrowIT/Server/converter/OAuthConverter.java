...
public class OAuthConverter {
    ...
    public static OAuthResponseDTO.OAuthLoginDTO toOAuthLoginDTO(Boolean signupRequired, OAuthApiResponseDTO.OAuthUserInfoDTO oAuthUserInfo, TokenResponseDTO.TokenDTO tokens) {
