...
public interface ChallengeSpecification {
    ...
    ApiResponse<ChallengeResponseDTO> updateChallengeProof(@PathVariable Long userChallengeId, @RequestBody ChallengeRequestDTO.UpdateRequestDTO updateRequest);
