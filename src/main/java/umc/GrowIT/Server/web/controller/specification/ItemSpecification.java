...
public interface ItemSpecification {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "COMMON_200", description = "⭕ SUCCESS"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ITEM_400_02", description = "❌ 착용중인 아이템이 아닙니다.", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ITEM_404_01", description = "❌ 아이템을 찾을 수 없습니다.", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "ITEM_409_02", description = "❌ 이미 보유 중인 아이템입니다.", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
